...
{
    [TestFixture]
    public class CheckSankoAbnormalDifficultySettingsTest
    {
        private CheckSankoAbnormalDifficultySettings check = null!;
        ...
        public void Setup()
        {
            check = new CheckSankoAbnormalDifficultySettings();
