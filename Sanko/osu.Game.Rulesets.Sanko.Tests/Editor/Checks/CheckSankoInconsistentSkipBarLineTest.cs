...
namespace osu.Game.Rulesets.Sanko.Tests.Editor.Checks
{
    [TestFixture]
    public class CheckSankoInconsistentSkipBarLineTest
    {
        private CheckSankoInconsistentSkipBarLine check = null!;

        [SetUp]
        public void Setup()
        {
            check = new CheckSankoInconsistentSkipBarLine();
        }
        ...
        public void TestInconsistentOmitFirstBarLine()
        {
            ...
            Assert.That(issues.All(issue => issue.Template is CheckSankoInconsistentSkipBarLine.IssueTemplateInconsistentOmitFirstBarLine));
        ...
        public void TestPartiallyInconsistentOmitFirstBarLine()
        {
            ...
            Assert.That(issues[0].Template is CheckSankoInconsistentSkipBarLine.IssueTemplateInconsistentOmitFirstBarLine);
        ...
        [Test]
        public void TestNonSankoBeatmaps()
        {
            var beatmaps = createBeatmapSetWithTimingPoints(
                new[] { (1000.0, false), (2000.0, true) }, // Reference
                new[] { (1000.0, true), (2000.0, false) } // Different settings
        ...
        public void TestMixedRulesets()
        {
            ...
            // Make reference sanko, other non-sanko
            beatmaps[0].BeatmapInfo.Ruleset = new SankoRuleset().RulesetInfo;
            beatmaps[1].BeatmapInfo.Ruleset = new OsuRuleset().RulesetInfo;
        ...
        private IBeatmap[] createBeatmapSetWithTimingPoints(params (double time, bool omitFirstBarLine)[][] timingData)
        {
            ...
            for (int i = 0; i < timingData.Length; i++)
            {
                ...
                beatmaps[i].BeatmapInfo.Ruleset = new SankoRuleset().RulesetInfo;
            }
