...
{
    public partial class TestSceneSankoEditorSaving : EditorSavingTestScene
    {
        ...
        [TestCase(2f)]
        [TestCase(2.4f)]
        public void TestSankoSliderMultiplierInExport(float? multiplier)
        {
        ...
        [Test]
        public void TestSankoSliderMultiplier()
        {
            AddStep("Set slider multiplier", () => EditorBeatmap.Difficulty.SliderMultiplier = 2);

            SaveEditor();

            AddAssert("Beatmap has correct slider multiplier", assertSankoSliderMulitplier);

            ReloadEditorToSameBeatmap();

            AddAssert("Beatmap still has correct slider multiplier", assertSankoSliderMulitplier);

            bool assertSankoSliderMulitplier()
            {
