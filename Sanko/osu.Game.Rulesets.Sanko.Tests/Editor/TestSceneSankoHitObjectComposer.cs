...
{
    public partial class TestSceneSankoHitObjectComposer : EditorClockTestScene
    {
        [SetUp]
        ...
        private partial class TestComposer : CompositeDrawable
        {
            ...
            public TestComposer()
            {
                ...
                {
                    EditorBeatmap = new EditorBeatmap(new SankoBeatmap
                    {
                        BeatmapInfo = { Ruleset = new SankoRuleset().RulesetInfo }
                    }),
                    new SankoHitObjectComposer(new SankoRuleset())
                };
