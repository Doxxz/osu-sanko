...
namespace osu.Game.Rulesets.Sanko.Tests.Judgements
{
    public partial class JudgementTest : RateAdjustedBeatmapTestScene
    {
        ...
        protected void PerformTest(List<ReplayFrame> frames, Beatmap<SankoHitObject>? beatmap = null, Mod[]? mods = null)
        {
            AddStep("load player", () =>
            {
                Beatmap.Value = CreateWorkingBeatmap(beatmap);
                Ruleset.Value = new SankoRuleset().RulesetInfo;
        ...
        protected Beatmap<SankoHitObject> CreateBeatmap(params SankoHitObject[] hitObjects)
        {
