    ...
    public partial class TestSceneSwellJudgements : JudgementTest
    {
        ...
        public void TestHitAllSwell()
        {
            ...
            for (int i = 0; i < swell.RequiredHits; i++)
            {
                ...
                frames.Add(new SankoReplayFrame(frameTime, i % 2 == 0 ? SankoAction.LeftCentre : SankoAction.LeftRim));
                frames.Add(new SankoReplayFrame(frameTime + 10));
            }
        ...
        public void TestAlternatingIsRequired()
        {
            ...
            {
                double frameTime = 1000 + i * 50;
                frames.Add(new SankoReplayFrame(frameTime, SankoAction.LeftCentre));
                frames.Add(new SankoReplayFrame(frameTime + 10));
            }
        ...
        public void TestAtMostOneSwellTickJudgedPerFrame()
        {
            ...
            List<ReplayFrame> frames = new List<ReplayFrame>
            {
                ...
                new SankoReplayFrame(1250, SankoAction.LeftCentre, SankoAction.LeftRim),
                new SankoReplayFrame(1251),
                new SankoReplayFrame(1500, SankoAction.LeftCentre, SankoAction.LeftRim, SankoAction.RightCentre, SankoAction.RightRim),
        ...
        public void TestHitSwellThenHitHit()
        {
            ...
            {
                new SankoReplayFrame(0),
                new SankoReplayFrame(swell_time, SankoAction.LeftRim),
                new SankoReplayFrame(hit_time, SankoAction.RightCentre),
            };
