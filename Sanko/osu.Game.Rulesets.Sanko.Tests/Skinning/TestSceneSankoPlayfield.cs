...
{
    public partial class TestSceneSankoPlayfield : SankoSkinnableTestScene
    {
        ...
        {
            SankoBeatmap beatmap;
            AddStep("set beatmap", () =>
            {
                Beatmap.Value = CreateWorkingBeatmap(beatmap = new SankoBeatmap());
            ...
            AddStep("Load playfield", () => SetContents(_ => new Container
            {
                ...
                Child = new SankoPlayfieldAdjustmentContainer { Child = new SankoPlayfield() },
            }));
        }
        ...
        public void TestHeightChanges()
        {
            ...
            AddRepeatStep("change height", () =>
            {
                ...
                this.ChildrenOfType<SankoPlayfieldAdjustmentContainer>().ForEach(p =>
                {
