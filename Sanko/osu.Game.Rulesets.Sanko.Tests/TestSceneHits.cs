...
{
    [TestFixture]
    public partial class TestSceneHits : DrawableSankoRulesetTestScene
    {
        ...
        private void addHitJudgement(bool kiai)
        {
            ...
            ((SankoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new JudgementResult(hit, new SankoJudgement()) { Type = hitResult });
        }
        ...
        private void addStrongHitJudgement(bool kiai)
        {
            ...
            ((SankoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new JudgementResult(hit, new SankoJudgement()) { Type = hitResult });
            ((SankoPlayfield)DrawableRuleset.Playfield).OnNewResult(h.NestedHitObjects.Single(), new JudgementResult(hit.NestedHitObjects.Single(), new SankoStrongJudgement()) { Type = HitResult.Great });
        }
        ...
        private void addMissJudgement()
        {
            ...
            ((SankoPlayfield)DrawableRuleset.Playfield).OnNewResult(h, new JudgementResult(h.HitObject, new SankoJudgement()) { Type = HitResult.Miss });
        }
