...
namespace osu.Game.Rulesets.Sanko.Tests
{
    public partial class TestSceneLegacyReplayPlayback : LegacyReplayPlaybackTestScene
    {
        ...
        public void TestHitWindowTreatment(float overallDifficulty, double hitOffset, HitResult expectedResult)
        {
            ...
            var replay = new Replay
            {
                Frames =
                {
                    ...
                    new SankoReplayFrame(hit_time + hitOffset, SankoAction.LeftCentre),
                    new SankoReplayFrame(hit_time + hitOffset + 20),
                }
            };
        ...
        private static SankoBeatmap createBeatmap(float overallDifficulty)
        {
