...
{
    /// <summary>
    /// Sanko doesn't output any samples. They are all handled externally by <see cref="DrumSamplePlayer"/>.
    /// </summary>
    [HeadlessTest]
    public partial class TestSceneSampleOutput : TestSceneSankoPlayer
    {
        ...
        protected override IBeatmap CreateBeatmap(RulesetInfo ruleset) => new SankoBeatmapConversionTest().GetBeatmap("sample-to-type-conversions");
    }
}
