...
namespace osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Colour.Data
{
    ...
    public class AlternatingMonoPattern
    {
        ...
        /// <summary>
        /// The first <see cref="SankoDifficultyHitObject"/> in this <see cref="AlternatingMonoPattern"/>.
        /// </summary>
        public SankoDifficultyHitObject FirstHitObject => MonoStreaks[0].FirstHitObject;
