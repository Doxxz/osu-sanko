...
namespace osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Colour.Data
{
    ...
    public class RepeatingHitPatterns
    {
        ...
        /// <summary>
        /// The first <see cref="SankoDifficultyHitObject"/> in this <see cref="RepeatingHitPatterns"/>
        /// </summary>
        public SankoDifficultyHitObject FirstHitObject => AlternatingMonoPatterns[0].FirstHitObject;
