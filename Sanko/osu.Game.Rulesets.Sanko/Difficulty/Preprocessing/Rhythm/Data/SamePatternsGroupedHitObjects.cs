...
namespace osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Rhythm.Data
{
    ...
    public class SamePatternsGroupedHitObjects
    {
        ...
        public SankoDifficultyHitObject FirstHitObject => Groups[0].FirstHitObject;

        public IEnumerable<SankoDifficultyHitObject> AllHitObjects => Groups.SelectMany(hitObject => hitObject.HitObjects);
