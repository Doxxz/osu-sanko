...
namespace osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Rhythm.Data
{
    /// <summary>
    /// Represents a group of <see cref="SankoDifficultyHitObject"/>s with no rhythm variation.
    /// </summary>
    public class SameRhythmHitObjectGrouping : IHasInterval
    {
        public readonly List<SankoDifficultyHitObject> HitObjects;
        ...
        public SameRhythmHitObjectGrouping(SameRhythmHitObjectGrouping? previous, List<SankoDifficultyHitObject> hitObjects)
        {
            Previous = previous;
