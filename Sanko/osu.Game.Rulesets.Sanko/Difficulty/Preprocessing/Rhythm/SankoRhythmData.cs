...
using System;
using System.Linq;
using osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Rhythm.Data;

namespace osu.Game.Rulesets.Sanko.Difficulty.Preprocessing.Rhythm
{
    /// <summary>
    /// Stores rhythm data for a <see cref="SankoDifficultyHitObject"/>.
    /// </summary>
    public class SankoRhythmData
    {
        /// <summary>
        ...
        /// <summary>
        /// Initialises a new instance of <see cref="SankoRhythmData"/>s,
        /// calculating the closest rhythm change and its associated difficulty for the current hit object.
        /// </summary>
        /// <param name="current">The current <see cref="SankoDifficultyHitObject"/> being processed.</param>
        public SankoRhythmData(SankoDifficultyHitObject current)
        {
        ...
        /// <summary>
        /// List of most common rhythm changes in sanko maps. Based on how each object's interval compares to the previous object.
        /// </summary>
        /// <remarks>
