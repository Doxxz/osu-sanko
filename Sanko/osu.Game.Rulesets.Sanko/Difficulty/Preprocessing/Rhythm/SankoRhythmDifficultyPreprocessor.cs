...
{
    public static class SankoRhythmDifficultyPreprocessor
    {
        public static void ProcessAndAssign(List<SankoDifficultyHitObject> hitObjects)
        {
        ...
        private static List<SameRhythmHitObjectGrouping> createSameRhythmGroupedHitObjects(List<SankoDifficultyHitObject> hitObjects)
        {
