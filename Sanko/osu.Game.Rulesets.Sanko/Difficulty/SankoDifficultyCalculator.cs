...
using osu.Game.Rulesets.Sanko.Difficulty.Skills;
using osu.Game.Rulesets.Sanko.Mods;
using osu.Game.Utils;

namespace osu.Game.Rulesets.Sanko.Difficulty
{
    public class SankoDifficultyCalculator : DifficultyCalculator
    {
        ...
        public SankoDifficultyCalculator(IRulesetInfo ruleset, IWorkingBeatmap beatmap)
        ...
        protected override Skill[] CreateSkills(IBeatmap beatmap, Mod[] mods)
        {
            ...
            isRelax = mods.Any(h => h is SankoModRelax);
        ...
        {
            new SankoModDoubleTime(),
            new SankoModHalfTime(),
            new SankoModEasy(),
        ...
        protected override IEnumerable<DifficultyHitObject> CreateDifficultyHitObjects(IBeatmap beatmap, Mod[] mods)
        {
            ...
            // Generate SankoDifficultyHitObjects from the beatmap's hit objects.
        ...
        protected override DifficultyAttributes CreateDifficultyAttributes(IBeatmap beatmap, Mod[] mods, Skill[] skills)
        {
            if (beatmap.HitObjects.Count == 0)
                return new SankoDifficultyAttributes { Mods = mods };
            ...
            // As we don't have pattern integration in osu!sanko, we apply the other two skills relative to rhythm.
            ...
            SankoDifficultyAttributes attributes = new SankoDifficultyAttributes
            {
