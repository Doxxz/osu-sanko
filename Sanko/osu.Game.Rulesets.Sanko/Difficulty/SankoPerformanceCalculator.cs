...
namespace osu.Game.Rulesets.Sanko.Difficulty
{
    public class SankoPerformanceCalculator : PerformanceCalculator
    {
        ...
        public SankoPerformanceCalculator()
        ...
        {
            var sankoAttributes = (SankoDifficultyAttributes)attributes;
            ...
            HitWindows hitWindows = new SankoHitWindows();
            ...
            totalDifficultHits = totalHits * sankoAttributes.ConsistencyFactor;
            ...
            double difficultyValue = computeDifficultyValue(score, sankoAttributes, isConvert, isClassic) * 1.08;
            double accuracyValue = computeAccuracyValue(score, sankoAttributes, isConvert) * 1.1;

            return new SankoPerformanceAttributes
            {
        ...
        private double computeDifficultyValue(ScoreInfo score, SankoDifficultyAttributes attributes, bool isConvert, bool isClassic)
        {
            ...
            if (score.Mods.Any(m => m is ModFlashlight<SankoHitObject>))
        ...
        private double computeAccuracyValue(ScoreInfo score, SankoDifficultyAttributes attributes, bool isConvert)
        {
            ...
            if (score.Mods.Any(m => m is ModFlashlight<SankoHitObject>) && score.Mods.Any(m => m is ModHidden) && !isConvert)
