...
namespace osu.Game.Rulesets.Sanko.Difficulty.Utils
{
    /// <summary>
    /// Normalises deltaTime values for SankoDifficultyHitObjects.
    /// </summary>
    public static class DeltaTimeNormaliser
    {
        ...
        /// </summary>
        public static Dictionary<SankoDifficultyHitObject, double> Normalise(
            IReadOnlyList<SankoDifficultyHitObject> hitObjects,
