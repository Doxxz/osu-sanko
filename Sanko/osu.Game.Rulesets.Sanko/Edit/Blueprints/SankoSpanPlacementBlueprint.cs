...
{
    public partial class SankoSpanPlacementBlueprint : HitObjectPlacementBlueprint
    {
        ...
        public SankoSpanPlacementBlueprint(HitObject hitObject)
            : base(hitObject)
        {
            ...
            Children = new Drawable[]
            {
                ...
                {
                    Height = SankoHitObject.DEFAULT_SIZE * SankoPlayfield.BASE_HEIGHT
                },
