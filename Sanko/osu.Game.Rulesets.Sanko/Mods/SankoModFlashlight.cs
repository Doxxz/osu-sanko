...
{
    public partial class SankoModFlashlight : ModFlashlight<SankoHitObject>
    {
        ...
        protected override Flashlight CreateFlashlight() => new SankoFlashlight(this, DrawableRuleset);

        protected DrawableSankoRuleset DrawableRuleset { get; private set; } = null!;

        public override void ApplyToDrawableRuleset(DrawableRuleset<SankoHitObject> drawableRuleset)
        {
            DrawableRuleset = (DrawableSankoRuleset)drawableRuleset;
            base.ApplyToDrawableRuleset(drawableRuleset);
        }

        public partial class SankoFlashlight : Flashlight
        {
            ...
            private readonly DrawableSankoRuleset drawableRuleset;

            public SankoFlashlight(SankoModFlashlight modFlashlight, DrawableSankoRuleset drawableRuleset)
                : base(modFlashlight)
            {
            ...
            protected override void Update()
            {
                ...
                if (!flashlightProperties.IsValid)
                {
                    ...
                    // the final factor is attempting to compensate for the aspect ratio clamping logic in `SankoPlayfieldAdjustmentContainer`
