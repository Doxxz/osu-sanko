...
{
    public class SankoModHidden : ModHidden, IApplicableToDrawableRuleset<SankoHitObject>
    {
        ...
        private DrawableSankoRuleset drawableRuleset = null!;

        public void ApplyToDrawableRuleset(DrawableRuleset<SankoHitObject> drawableRuleset)
        {
            this.drawableRuleset = (DrawableSankoRuleset)drawableRuleset;
        }
