...
{
    public class SankoModSimplifiedRhythm : Mod, IApplicableToBeatmap
    {
        ...
        public void ApplyToBeatmap(IBeatmap beatmap)
        {
            ...
            var controlPointInfo = sankoBeatmap.ControlPointInfo;

            Hit[] hits = sankoBeatmap.HitObjects.OfType<Hit>().ToArray();
                    ...
                    for (int j = patternStartIndex; j < patternEndIndex; j++)
                    {
                        ...
                        switch (baseRhythm)
                        {
                            ...
                            case 8:
                            {
                                ...
                                {
                                    sankoBeatmap.HitObjects.Remove(hits[j]);
                                }
            ...
            sankoBeatmap.HitObjects.Sort((a, b) => a.StartTime.CompareTo(b.StartTime));
        }
