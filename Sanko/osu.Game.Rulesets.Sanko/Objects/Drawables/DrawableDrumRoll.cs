...
{
    public partial class DrawableDrumRoll : DrawableSankoStrongableHitObject<DrumRoll, DrumRoll.StrongNestedHit>
    {
        /// <summary>
        ...
        protected override void RecreatePieces()
        {
            ...
            updateColour();
            Height = HitObject.IsStrong ? SankoStrongableHitObject.DEFAULT_STRONG_SIZE : SankoHitObject.DEFAULT_SIZE;
        }
        ...
        protected override SkinnableDrawable CreateMainPiece() => new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.DrumRollBody),
            _ => new ElongatedCirclePiece());

        private SkinnableDrawable createHeadPiece() => new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.DrumRollHead), _ => Empty())
        {
            RelativeSizeAxes = Axes.Y,
            Depth = -2,
        };
