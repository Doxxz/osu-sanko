...
{
    public partial class DrawableDrumRollTick : DrawableSankoStrongableHitObject<DrumRollTick, DrumRollTick.StrongNestedHit>
    {
        public BindableBool IsFirstTick = new BindableBool();

        /// <summary>
        /// The hit type corresponding to the <see cref="SankoAction"/> that the user pressed to hit this <see cref="DrawableDrumRollTick"/>.
        /// </summary>
        ...
        protected override SkinnableDrawable CreateMainPiece() => new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.DrumRollTick), _ => new TickPiece());
        ...
        {
            JudgementType = e.Action switch
            {
                SankoAction.LeftRim or SankoAction.RightRim => HitType.Rim,
                SankoAction.LeftTsu or SankoAction.RightTsu => HitType.Tsu,
                _ => HitType.Centre,
            };
        ...
        public partial class StrongNestedHit : DrawableStrongNestedHit
        {
            ...
            public override bool OnPressed(KeyBindingPressEvent<SankoAction> e) => false;
        }
    }
}
