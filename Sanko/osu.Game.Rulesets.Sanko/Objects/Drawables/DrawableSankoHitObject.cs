...
{
    public abstract partial class DrawableSankoHitObject : DrawableHitObject<SankoHitObject>, IKeyBindingHandler<SankoAction>
    {
        [CanBeNull]
        public new DrawableSankoHitObject ParentHitObject => base.ParentHitObject as DrawableSankoHitObject;
        ...
        protected DrawableSankoHitObject([CanBeNull] SankoHitObject hitObject)
            : base(hitObject)
        {
        ...
        /// <summary>
        /// Creates a proxy for the content of this <see cref="DrawableSankoHitObject"/>.
        /// </summary>
        public Drawable CreateProxiedContent() => proxiedContent.CreateProxy();

        public abstract bool OnPressed(KeyBindingPressEvent<SankoAction> e);

        public virtual void OnReleased(KeyBindingReleaseEvent<SankoAction> e)
        {
        }
        ...
        // osu!sanko hitsounds are managed by the drum (see DrumSampleTriggerSource).
        public sealed override IEnumerable<HitSampleInfo> GetSamples() => Enumerable.Empty<HitSampleInfo>();
    }

    public abstract partial class DrawableSankoHitObject<TObject> : DrawableSankoHitObject
        where TObject : SankoHitObject
    {
        ...
        protected DrawableSankoHitObject([CanBeNull] TObject hitObject)
            : base(hitObject)
        {
