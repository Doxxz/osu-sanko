...
{
    public abstract partial class DrawableSankoStrongableHitObject<TObject, TStrongNestedObject> : DrawableSankoHitObject<TObject>
        where TObject : SankoStrongableHitObject
        where TStrongNestedObject : StrongNestedHitObject
    {
        ...
        protected DrawableSankoStrongableHitObject([CanBeNull] TObject hitObject)
            : base(hitObject)
        {
        ...
        /// This is only invoked if <see cref="SankoStrongableHitObject.IsStrong"/> is true for <see cref="HitObject"/>.
        /// </summary>
