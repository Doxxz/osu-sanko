...
{
    /// <summary>
    /// Used as a nested hitobject to provide <see cref="SankoStrongJudgement"/>s for <see cref="DrawableSankoStrongableHitObject{TObject,TStrongNestedObject}"/>s.
    /// </summary>
    public abstract partial class DrawableStrongNestedHit : DrawableSankoHitObject
    {
