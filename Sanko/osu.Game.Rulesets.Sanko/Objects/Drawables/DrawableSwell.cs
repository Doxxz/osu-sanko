...
{
    public partial class DrawableSwell : DrawableSankoHitObject<Swell>
    {
        /// <summary>
        ...
        protected override SkinnableDrawable CreateMainPiece() => new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.Swell),
            _ => new DefaultSwell
            {
        ...
        {
            base.RecreatePieces();
            Size = baseSize = new Vector2(SankoHitObject.DEFAULT_SIZE);
        }
        ...
        public override bool OnPressed(KeyBindingPressEvent<SankoAction> e)
        {
            ...
            bool isCentre = e.Action == SankoAction.LeftCentre || e.Action == SankoAction.RightCentre;
