...
{
    public class DrumRoll : SankoStrongableHitObject, IHasPath
    {
        /// <summary>
        ...
        protected override void ApplyDefaultsToSelf(ControlPointInfo controlPointInfo, IBeatmapDifficultyInfo difficulty)
        {
            ...
            double scoringDistance = base_distance * (difficulty.SliderMultiplier * SankoBeatmapConverter.VELOCITY_MULTIPLIER) * effectPoint.ScrollSpeed;
        ...
        SliderPath IHasPath.Path
            => new SliderPath(PathType.LINEAR, new[] { Vector2.Zero, new Vector2(1) }, ((IHasDistance)this).Distance / SankoBeatmapConverter.VELOCITY_MULTIPLIER);
