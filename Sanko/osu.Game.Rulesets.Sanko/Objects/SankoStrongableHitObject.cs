...
{
    /// <summary>
    /// Base class for sanko hitobjects that can become strong (large).
    /// </summary>
    public abstract class SankoStrongableHitObject : SankoHitObject
    {
        /// <summary>
        /// Scale multiplier for a strong drawable sanko hit object.
        /// </summary>
        public const float STRONG_SCALE = 1 / 0.65f;

        /// <summary>
        /// Default size of a strong drawable sanko hit object.
        /// </summary>
        ...
        protected SankoStrongableHitObject()
        {
