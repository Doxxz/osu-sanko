...
{
    /// <summary>
    /// A <see cref="HealthProcessor"/> for the sanko ruleset.
    /// Sanko fails if the player has not half-filled their health by the end of the map.
    /// </summary>
    public partial class SankoHealthProcessor : AccumulatingHealthProcessor
    {
        /// <summary>
