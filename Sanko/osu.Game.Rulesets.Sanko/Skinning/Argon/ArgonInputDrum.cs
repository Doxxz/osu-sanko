...
namespace osu.Game.Rulesets.Sanko.Skinning.Argon
{
    public partial class ArgonInputDrum : AspectContainer
    {
        ...
        public static readonly ColourInfo TSU_HIT_GRADIENT = ColourInfo.GradientHorizontal(
            new Color4(227, 255, 227, 255),
            new Color4(198, 255, 205, 255)
        );

        public static readonly Colour4 TSU_HIT_GLOW = new Color4(126, 253, 150, 255);
        ...
        /// </summary>
        private partial class SankoHalfDrum : CompositeDrawable, IKeyBindingHandler<SankoAction>
        {
            /// <summary>
            ...
            private readonly Drawable tsuHit;
            private readonly Drawable centreHit;

            public SankoHalfDrum(bool flipped)
            {
                    ...
                    new Container
                    {
                        ...
                        Children = new[]
                        {
                            ...
                            tsuHit = new Circle
                            {
                                ...
                                Origin = Anchor.Centre,
                                RelativeSizeAxes = Axes.Both,
                                Colour = TSU_HIT_GRADIENT,
                                EdgeEffect = new EdgeEffectParameters
                                {
                                    Type = EdgeEffectType.Glow,
                                    Colour = TSU_HIT_GLOW.Opacity(0.66f),
                                    Radius = 50,
                                },
                                Alpha = 0,
                            },
