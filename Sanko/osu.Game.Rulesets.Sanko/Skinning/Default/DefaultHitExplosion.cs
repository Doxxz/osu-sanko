...
namespace osu.Game.Rulesets.Sanko.Skinning.Default
{
    internal partial class DefaultHitExplosion : CircularContainer, IAnimatableHitExplosion
    {
        ...
        private void updateColour(DrawableHitObject? judgedObject = null)
        {
            ...
            bool isTsu = (judgedObject?.HitObject as Hit)?.Type == HitType.Tsu;
            body.Colour = isTsu ? Hit.COLOUR_TSU : isRim ? colours.BlueDarker : colours.PinkDarker;
        }
        ...
        {
            this.ResizeTo(new Vector2(SankoStrongableHitObject.STRONG_SCALE), 50);
        }
    }
}
