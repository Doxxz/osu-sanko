...
namespace osu.Game.Rulesets.Sanko.Skinning.Default
{
    public partial class DefaultInputDrum : AspectContainer
    {
        ...
        /// </summary>
        private partial class SankoHalfDrum : Container, IKeyBindingHandler<SankoAction>
        {
            /// <summary>
            ...
            private readonly Sprite tsu;
            private readonly Sprite tsuHit;
            ...
            private void load(TextureStore textures, OsuColour colours)
            {
                ...
                tsu.Texture = textures.Get(@"Gameplay/taiko/taiko-drum-outer");
                tsuHit.Texture = textures.Get(@"Gameplay/taiko/taiko-drum-outer-hit");
