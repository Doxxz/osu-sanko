    ...
    public partial class LegacyCirclePiece : CompositeDrawable, IHasAccentColour
    {
        ...
        private void load(ISkinSource skin, DrawableHitObject drawableHitObject, IBeatSyncProvider? beatSyncProvider)
        {
            Drawable? getDrawableFor(string lookup, bool animatable)
            {
                ...
                string prefix = ((drawableHitObject.HitObject as SankoStrongableHitObject)?.IsStrong ?? false) ? big_hit : normal_hit;
            ...
            // backgroundLayer is guaranteed to exist due to the pre-check in SankoLegacySkinTransformer.
            ...
            if (foregroundLayer != null)
            {
                ...
                // Animations in sanko skins are used in a custom way (>150 combo and animating in time with beat).
