...
{
    public partial class SankoPlayfield : ScrollingPlayfield
    {
        /// <summary>
        /// Base height of a <see cref="SankoPlayfield"/> when inside a <see cref="DrawableSankoRuleset"/>.
        /// </summary>
        ...
        private JudgementContainer<DrawableSankoJudgement> judgementContainer = null!;
        ...
        private JudgementPooler<DrawableSankoJudgement> judgementPooler = null!;
        ...
        private void load(OsuColour colours, SankoRulesetConfigManager? config)
        {
            config?.BindWith(SankoRulesetSetting.HitAnimations, hitAnimations);
            ...
            {
                new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.PlayfieldBackgroundRight), _ => new PlayfieldBackgroundRight()),
                new Container
                {
                    Name = "Left overlay",
                    RelativeSizeAxes = Axes.Y,
                    ...
                    Children = new[]
                    {
                        new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.PlayfieldBackgroundLeft), _ => new PlayfieldBackgroundLeft()),
                        inputDrum.CreateProxy(),
                    }
                },
                new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.Mascot), _ => Empty())
                {
                ...
                new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        new Container
                        {
                            ...
                            Children = new[]
                            {
                                new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.KiaiGlow), _ => Empty())
                                {
                                    RelativeSizeAxes = Axes.Both,
                                },
                                ...
                                HitTarget = new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.HitTarget), _ => new SankoHitTarget())
                                {
                                    RelativeSizeAxes = Axes.Both,
                                }
                            }
                        ...
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                judgementContainer = new JudgementContainer<DrawableSankoJudgement>
                                {
                                    Name = "Judgements",
                                    Origin = Anchor.TopCentre,
                                    RelativeSizeAxes = Axes.Both,
                ...
                new SkinnableDrawable(new SankoSkinComponentLookup(SankoSkinComponents.DrumSamplePlayer), _ => new DrumSamplePlayer())
                {
                    RelativeSizeAxes = Axes.Both,
                },
                // this is added at the end of the hierarchy to receive input before sanko objects.
            ...
            AddInternal(judgementPooler = new JudgementPooler<DrawableSankoJudgement>(usableHitResults));
        ...
        protected override void OnNewDrawableHitObject(DrawableHitObject drawableHitObject)
        {
            ...
            var sankoObject = (DrawableSankoHitObject)drawableHitObject;
            topLevelHitContainer.Add(sankoObject.CreateProxiedContent());
        }
        ...
        public override void Add(HitObject h)
        {
            switch (h)
            {
                ...
                case SankoHitObject sankoHitObject:
                    base.Add(sankoHitObject);
                    break;
        ...
        public override bool Remove(HitObject h)
        {
            switch (h)
            {
                ...
                case SankoHitObject sankoHitObject:
                    return base.Remove(sankoHitObject);
        ...
        internal void OnNewResult(DrawableHitObject judgedObject, JudgementResult result)
        {
            ...
            switch (result.Judgement)
            {
                ...
                case SankoDrumRollTickJudgement:
                    if (!result.IsHit)
                        break;
