...
{
    public partial class SankoPlayfieldAdjustmentContainer : PlayfieldAdjustmentContainer
    {
        ...
        public SankoPlayfieldAdjustmentContainer()
        {
            RelativeSizeAxes = Axes.X;
            RelativePositionAxes = Axes.Y;
            Height = SankoPlayfield.BASE_HEIGHT;
        ...
        protected override void Update()
        {
            ...
            const float base_relative_height = SankoPlayfield.BASE_HEIGHT / 768;
        ...
        public double ComputeTimeRange()
        {
            ...
            inMsLength /= SankoBeatmapConverter.VELOCITY_MULTIPLIER;
